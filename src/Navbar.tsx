        ...
        <div className="hidden md:flex items-center justify-center gap-5">
          ...
          {userModal &&  (
              ...
              >
                ...
                {(user?.publicMetadata?.role === "admin" || user?.publicMetadata?.role === "manager") && (
                <div className="flex flex-col gap-2"
                ...
                <div className="flex flex-col gap-2">
                  <div className="w-full h-10 bg-[#181c23] hover:bg-[#1e242d] transition-colors rounded-lg flex items-center gap-3 px-4 cursor-pointer"
                    ...
                    <span className="text-sm text-white">Iesi din cont</span>
                  </div>
                </div>
                </SignOutButton>
                 <a className="flex flex-col gap-2" href="mailto:contact@hackarest.ro">
                  <div className="w-full h-10 bg-[#181c23] hover:bg-[#1e242d] transition-colors rounded-lg flex items-center gap-3 px-4 cursor-pointer">
                ...
                {(user?.publicMetadata?.role === "admin" || user?.publicMetadata?.role === "manager") && (
                  <div className=" flex w-full items-center justify-center gap-2">
                      ...
                      <h1 className="text-xs text-red-500">Esti logat pe un cont de {user?.publicMetadata?.role}.</h1>
                  </div>
                )}
